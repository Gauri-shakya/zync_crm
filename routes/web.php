...
Route::middleware(['auth', CheckCompanyAccess::class])->group(function () {
    ...
    Route::middleware('permission:Attendance Records')->group(function () {
        ...
        Route::post('/attendance-record/import', [AttendanceRecordController::class, 'import'])->name('attendance-record.import');
        Route::get('/attendance-record/sample', [AttendanceRecordController::class, 'downloadSample'])->name('attendance-record.sample');
    ...
    Route::middleware('permission:proposal')->group(function () {
        ...
        Route::post('/proposals/upload-pdf', [ProposalController::class, 'uploadPdf'])->name('proposals.upload-pdf');
    ...
    Route::middleware('permission:To-Do')->group(function () {
    ...
    Route::middleware('permission:Calendar')->group(function () {
        ...
        Route::post('/calendar/apply-leave', [CalendarController::class, 'applyLeave'])->name('calendar.apply-leave');
        Route::post('/calendar/add-holiday', [CalendarController::class, 'addHoliday'])->name('calendar.add-holiday');
        Route::post('/calendar/import-holidays', [CalendarController::class, 'importHolidays'])->name('calendar.import');
        Route::get('/calendar/users', [CalendarController::class, 'getUsers'])->name('calendar.users');
    ...
    Route::middleware('permission:Links and Remarks')->group(function () {
...
// ------------------------------------------------------------------------------------
    ...
    //   Route::middleware(['auth', 'permission:Client Service Interaction'])->group(function () {
...
// ------------------------------------------------------------------------------------
    ...
    Route::middleware('permission:Raise Ticket')->prefix('user/support/ticket')
...
Route::get('/storage-unlink', function () {
    ...
    return 'Storage unlinked successfully';
});
