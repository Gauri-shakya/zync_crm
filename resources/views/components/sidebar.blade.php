...
if ($crmAccessible) {
    ...
    if(auth()->user()->can('Links and Remarks')) {
        $navItems[] = [
            'name' => 'Links',
     ...
     if(auth()->user()->can('Client Service Interaction')) {
       $navItems[] = [
            'name' => 'Interaction',
