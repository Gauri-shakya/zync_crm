...
@section('content')
    <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Mobile Comparison Cards (Visible on Mobile) -->
            <div class="md:hidden space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                    <div class="p-5 bg-gray-50 border-b border-gray-100">
                        <div class="flex justify-between items-center">
                            ...
                            @if($isTrial)
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">Trial</span>
                            @elseif($company->is_paid)
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Premium</span>
                            @else
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">Free</span>
                            @endif
                        </div>
                    </div>
                    <div class="p-5 space-y-4">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="font-medium text-gray-900">Up to 3</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                        ...
                        <div class="pt-4 border-t border-gray-50 text-center">
                            @if($isTrial)
                                <p class="text-xs text-amber-600 font-bold">Ends in {{ $trialRemaining }}</p>
                            @elseif($company->is_paid)
                                <p class="text-xs text-green-600 font-medium">Enjoy Premium Features</p>
                            @else
                                <p class="text-xs text-red-600 font-medium">Expired - Please Upgrade</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <!-- Premium Plan Card -->
                <div class="bg-white rounded-2xl shadow-xl border-2 border-sky-500 overflow-hidden relative">
                    <div class="absolute top-0 right-0">
                        <div class="bg-sky-500 text-white text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase tracking-wider">
                            Recommended
                        </div>
                    </div>
                    <div class="p-5 bg-sky-50 border-b border-sky-100">
                        <h3 class="text-lg font-bold text-sky-700">Premium Plan</h3>
                    </div>
                    <div class="p-5 space-y-4">
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500">Team Members</span>
                            <span class="font-bold text-sky-600">Unlimited</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500">Analytics</span>
                            <span class="font-bold text-sky-600">Advanced</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500">Targeting</span>
                            <span class="text-green-600 font-bold"><i class="fas fa-check"></i></span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-500">Support</span>
                            <span class="font-bold text-sky-600">24/7 Priority</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                        ...
                        <div class="pt-4">
                            @if(!$company->is_paid)
                                <button type="button" class="w-full bg-sky-600 text-white py-3 rounded-xl font-bold shadow-lg shadow-sky-200 active:scale-95 transition-transform">
                                    Upgrade Now
                                </button>
                            @else
                                <button type="button" disabled class="w-full bg-gray-100 text-gray-400 py-3 rounded-xl font-bold cursor-not-allowed">
                                    Current Plan
                                </button>
                            @endif
                        </div>
