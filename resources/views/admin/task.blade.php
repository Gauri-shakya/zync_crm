...
@section('content')
    ...
    <style>
        ...
        .user-checkbox-card.selected .check-indicator {
    ...
    <div class="flex flex-col min-h-screen">
                                ...
                                <div>
                                    ...
                                    <div class="mt-6">
                                        <button type="button" id="addRoleBtn"
                                            class="text-sm hidden text-indigo-600 hover:text-indigo-800 flex items-center font-medium">
        ...
        <script>
            ...
            function openModal() {
                ...
                // initializeCategoryFunctionality(); // Moved to global initialization
                setTimeout(() => {
            ...
            // Initialize category functionality once
