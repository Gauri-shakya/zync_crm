                ...
                @forelse($tickets as $ticket)
                    <div class="p-4 bg-white hover:bg-gray-50 transition-colors">
                        <div class="flex justify-between items-start mb-2">
                            <span class="text-xs font-bold text-blue-600">#{{ $ticket->ticket_id }}</span>
                        ...
                        <h3 class="text-sm font-bold text-gray-900 mb-1 break-words">{{ $ticket->title }}</h3>
                        <p class="text-xs text-gray-500 mb-3">{{ $ticket->category }}</p>
                        
                        <div class="flex items-center justify-between mt-4 pt-3 border-t border-gray-50">
                            <div class="flex items-center gap-2">
                                <div class="h-6 w-6 rounded-full bg-blue-50 flex items-center justify-center text-[10px] font-bold text-blue-600 uppercase border border-blue-100">
                                    {{ substr($ticket->client->name ?? 'U', 0, 2) }}
                                </div>
                            ...
                            <a href="{{ route('ticket.record.show', encrypt($ticket->id)) }}" 
                                ...
                                Manage Ticket <i class="fas fa-chevron-right ml-1"></i>
                            </a>
                        </div>
                    </div>
                @empty
